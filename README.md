...
By character count of everything this repository serves, **70.4% is the model's
and 29.6% is not**, counted by
...
and it designed the nine research features itself. That is 70.4% of the code this
repository serves, counted by
[`build/count_provenance.py`](build/count_provenance.py).

A coding assistant, Claude Code, was used for the other 29.6%: the frame at the
