...
By character count of everything this repository serves, **70.5% is the model's
and 29.5% is not**, counted by
...
and it designed the nine research features itself. That is 70.5% of the code this
repository serves, counted by
[`build/count_provenance.py`](build/count_provenance.py).

A coding assistant, Claude Code, was used for the other 29.5%: the frame at the
