...
/* ---- 27: written with its own eyes, written by the model ---- */
(function(){
"use strict";
...
(function(){var s=document.createElement('style');s.id='sdr-css-27';s.textContent=`#sentence{display:none!important}
...
.phbar>#count.sdcount{flex:0 0 100%;font:500 12.5px/1.35 'IBM Plex Mono',ui-monospace,monospace;margin:0 0 6px;max-width:none;color:var(--ink)}
