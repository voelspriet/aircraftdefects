#!/usr/bin/env python3
"""Film v3 at 2560x1440. Site shots come from cap3 (beats recorded in real
...
def shot(name):
    src = os.path.join(C3, name + '.webm'); mk = marks(name); total = probe(src)
