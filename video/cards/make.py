...
CARDS={
 ...
 'end': page('<div class="c" style="align-items:center;text-align:center"><div class="serif" style="font-size:150px;line-height:1.05">aircraftdefects.com<span style="color:#b8431f">/z</span></div><div style="font-size:34px;color:#6f6a62;margin-top:36px">Built with <span style="color:#245c5a;font-weight:600">GLM-5.3-Flash</span> · GLM-5.3 Flash Lightning Hackathon</div><div class="mono" style="font-size:24px;color:#6f6a62;margin-top:26px;letter-spacing:.1em">HENK VAN ESS · 2026</div></div>'),
...
with sync_playwright() as p:
    ...
    for k,html in CARDS.items():
        ...
        if k=='counter':
            ...
            pg=br.new_page(viewport={'width':1920,'height':1080}); pg.goto('file://'+path); pg.wait_for_timeout(1200)
